...
- understand the user's gesture from the video
...
- plain text only
- no JSON
- nationality is from: Sri lankan, chineese, black, unknown
- gender is from : male,female,unknown
- age_range is from child,teen,young_adult,adult,older_adult,unknown",
- no markdown
...
async def process_saved_video_with_live_events(saved_path: str, ws: WebSocket, user_id: str = "user"):
    ...
    try:
        ...
        t = now()
        print('sssssssssssssss',meta["avatar_emotion"], meta["mixamo_gesture"])
