...
class InternVLChatModel(PreTrainedModel):
    ...
    def __init__(self, config: InternVLChatConfig, use_flash_attn=True):
        ...
        #config.llm_config.vocab_size = 92661 
    ...
    def forward(
        ...
        #    loss = loss_fct(shift_logits, shift_labels)
            ...
            #        if i != ignore_index:
            #            decoded_preds = tokenizer.batch_decode([i.tolist()], skip_special_tokens=False)
            #            print("rrrrrrrrr",i,decoded_preds)
            ...
            loss = weighted_loss / norm.clamp(min=1) 
