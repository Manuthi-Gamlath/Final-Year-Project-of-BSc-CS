...
async def upload_video(
    ...
    try:
        ...
        # FAST VLM PROMPT (CSV)
        # -----------------------------
        #question = f"Identify the person's emotion from this list (happy, angry, sad, fear, disgust, surprised) and return only one word."
        #question = f"Identify the person's emotion from this list (happy, angry, sad, fear, disgust, surprised) and return only one word."
        question = f"""
(i) What is the person's emotion from this list (neutral,happy, angry, sad, fear, disgust, surprised).
(ii) What is the person's hand gesture.
(iii) What is the person's head gesture.

Return ONLY in this format:
emotion: <one word>
hand_gesture: <one word>
head_gesture: <one word>
"""
